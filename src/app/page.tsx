          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                ...
                <Link href="/dashboard" className="group flex items-center justify-center space-x-3 border-2 border-green-300 text-green-700 hover:border-green-500 hover:text-green-600 font-semibold py-4 px-8 rounded-2xl text-lg transition-all duration-300 transform hover:scale-105">
